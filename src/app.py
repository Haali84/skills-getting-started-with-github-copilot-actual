...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and matches for students who love soccer",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Relaxing stretches and mindfulness exercises for all skill levels",
    ...
    "Drama Workshop": {
        "description": "Acting exercises and rehearsal for school performances",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["mia@mergington.edu", "javier@mergington.edu"]
    },
    "Robotics Club": {
